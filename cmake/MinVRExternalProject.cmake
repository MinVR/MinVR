...
#     etc..
# )
function(MinVRExternalProject_Download DLHELPER_PROJECT_NAME)

    include(MessageMacros)
    h1("BEGIN MINVR EXTERNAL PROJECT DOWNLOAD (${DLHELPER_PROJECT_NAME}).")
    ...
    configure_file(
        ${MINVR_PROJECT_ROOT}/cmake/CMakeLists-DownloadHelper.txt.in 
...
#     etc..
# )
function(MinVRExternalProject_BuildAndInstallNow EXT_PROJECT_NAME RELPATH_TO_CMAKELISTS)

    include(MessageMacros)
    h1("BEGIN MINVR EXTERNAL PROJECT BUILD AND INSTALL (${EXT_PROJECT_NAME}).")
