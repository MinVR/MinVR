...
CoordinateFrame
VRG3DEvent::getCoordinateFrameData()
{
...
void
VRG3DEvent::serialize(BinaryOutput &b) const
{
...
void
VRG3DEvent::deserialize(BinaryInput &b)
{
...
createCopyOfEvent(EventRef e) {
  switch (e->getType()) {
  case VRG3DEvent::EVENTTYPE_STANDARD:
    return new VRG3DEvent(e->getName());
    break;
  case VRG3DEvent::EVENTTYPE_1D:
    return new VRG3DEvent(e->getName(),e->get1DData());
    break;
  case VRG3DEvent::EVENTTYPE_2D:
    return new VRG3DEvent(e->getName(),e->get2DData());
    break;
  case VRG3DEvent::EVENTTYPE_3D:
    return new VRG3DEvent(e->getName(),e->get3DData());
    break;
  case VRG3DEvent::EVENTTYPE_COORDINATEFRAME:
    return new VRG3DEvent(e->getName(),e->getCoordinateFrameData());
    break;
  case VRG3DEvent::EVENTTYPE_MSG:
    return new VRG3DEvent(e->getName(),e->getMsgData());
    break;
  default:
